"""
评估 LLaMA3.1-8B-Instruct No-CoT 模型在 Spider 上的 Text-to-SQL 性能。
"""
...
def main():
    ...
    for i, item in enumerate(test_data):
        ...
        if (i + 1) % 50 == 0:
            interim_file = args.output_file or str(PROJECT_DIR / "outcome" / "eval_results_llama_nocot.json")
    ...
    output_file = args.output_file or str(PROJECT_DIR / "outcome" / "eval_results_llama_nocot.json")
